#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/jbolla/ProxmoxVE/refs/heads/tandoor-install-version-test/misc/build.func)
# Copyright (c) 2021-2025 tteck
# Author: MickLesk (Canbiz)
# License: MIT | https://github.com/jbolla/ProxmoxVE/refs/heads/tandoor-install-version-test/LICENSE
